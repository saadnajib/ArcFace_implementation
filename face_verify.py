...
cap = cv2.VideoCapture(r"C:\Users\saadn\Desktop\arcface\Face-Recognition\videos\test3.mp4")
cap.set(3,500)
cap.set(4,500)
...
class faceRec:
    def __init__(self):
        ...
        self.image = None
    def main(self):
        # video_capture = cv2.VideoCapture(r"C:\Users\saadn\Desktop\arcface\Face-Recognition\videos\test3.mp4")
        # widthh = video_capture.get(cv2.CAP_PROP_FRAME_WIDTH)  # float
        # heightt = video_capture.get(cv2.CAP_PROP_FRAME_HEIGHT)  # float
        # video_recording = cv2.VideoWriter(r'C:\Users\saadn\Desktop\arcface\Face-Recognition\output_video\output.avi', fourcc, 10,(int(widthh), int(heightt)))
